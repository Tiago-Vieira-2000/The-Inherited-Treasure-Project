...
public class statue5 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(randomInt==1){
            arrayDegree= new int[5] {180, 90, 0, 0, 135};
        }
        else if(randomInt==2){
            arrayDegree= new int[5] {135, 0, 0, 90, 180};
        }
        else if(randomInt==3){
            arrayDegree= new int[5] {-45, -45, -90, -90, 135};
        }
        else if(randomInt==4){
            arrayDegree= new int[5] {180, 0, -45, 0, -90};
        }
        else if(randomInt==5){
            arrayDegree= new int[5] {90, 45, 90, 135, 45};
        }
